...
WeightMatrix* MCDMWeightReader::getMatrix()
{
    ...
    //int numCriteria = 3;
    matrix->insertSingleCriterion(INFORMATION_GAIN,0.75,true);
    matrix->insertSingleCriterion(TRAVEL_DISTANCE,0.1,true);
    ...
    matrix->insertCombinationWeight(list2,0.95);
    matrix->insertCombinationWeight(list3,0.2);

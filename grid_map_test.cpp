...
int main ( int argc, char **argv )
{
 ...
 myGrid.addCircle(likelihood, 0.0, 0.0, 50);
 // huge circle placed middle of X axis == vertical
 myGrid.addCircle(likelihood, 100.0, 0.0, 25);
 // huge circle placed  middle of y axis == horizontal
 myGrid.addCircle(likelihood, 0.0, 100.0, 50);
 // huge circle placed  center of image
 myGrid.addCircle(likelihood, 100.0, 100.0, 50);

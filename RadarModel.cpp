...
void RadarModel::getImageDebug(GridMap* gm, std::string layerName, std::string fileURI){
...
void RadarModel::debugInfo(){
    std::cout << ".................." << std::endl;
    Length mlen = _rfid_belief_maps.getLength();
    std::cout << "RFID belief area is: "<< mlen(0) << " by " << mlen(1) << " m. (x,y)" <<std::endl;
    std::cout << "Resolution is: " << _resolution<< " m. /cell" << std::endl;
    std::cout << "RFID belief grid is: "<< _rfid_belief_maps.getSize()(0) << " by " << _rfid_belief_maps.getSize()(1) << " cells (i,j axis)" <<std::endl;
    std::cout << ". " << std::endl;

...
# Remove the first columns containing the weights values leaving <configuration, coverage, TravelledDistance>
...
# # Remove the third colum (TravelledDistance) leaving <configuration, Coverage>
mcdm_data_1 = np.delete(mcdm_data_1, 2, 1)
mcdm_data_2 = np.delete(mcdm_data_2, 2, 1)
mcdm_data_3 = np.delete(mcdm_data_3, 2, 1)
# stachniss_data_1 = np.delete(stachniss_data_1, 2, 1)
# stachniss_data_2 = np.delete(stachniss_data_2, 2, 1)
# stachniss_data_3 = np.delete(stachniss_data_3, 2, 1)
random_frontier_data_1 = np.delete(random_frontier_data_1, 2, 1)
random_frontier_data_2 = np.delete(random_frontier_data_2, 2, 1)
random_frontier_data_3 = np.delete(random_frontier_data_3, 2, 1)
random_walk_data_1 = np.delete(random_walk_data_1, 2, 1)
random_walk_data_2 = np.delete(random_walk_data_2, 2, 1)
random_walk_data_3 = np.delete(random_walk_data_3, 2, 1)
...
# print(len(random_frontier_data_1), len(random_frontier_data_2), len(random_frontier_data_3))
# print(len(unique_rf_1), len(unique_rf_2), len(unique_rf_3))
...
plt.axvline(x=final_rw.shape[0] + 1, color='#3F7F4C', linestyle="--")

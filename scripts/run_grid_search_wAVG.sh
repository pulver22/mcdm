...
do
    ...
    do
        ...
        echo "Testing : [$w_info_gain , $w_travel_distance, $w_sensing_time] "
        ./../build/mcdm_online_exploration ./../Images/inbeng_small_correct.pgm 1 72 124 180 26 180 0.999 0 1 ./../config/tag_inbeng_1.yaml 865e6 0 $w_info_gain $w_travel_distance $w_sensing_time $w_rfid_gain /tmp/result_gs_wAVG_r1.csv /tmp/coverage_gs_wAVG_r1.csv /tmp/distance_gs_wAVG_r1.csv 1 /tmp/accuracy_gs_wAVG_r1.csv $use_mcdm &>/dev/null &
        ((counter++))
        if ((counter%batch_size==0))
        then
            wait
...
do
    ...
    do
        ...
        # echo "-->[A] IG: $w_info_gain, TD: $w_travel_distance, ST: $w_sensing_time"
        echo "Testing : [$w_info_gain , $w_travel_distance, $w_sensing_time] "
        ./../build/mcdm_online_exploration ./../Images/inbeng_small_correct.pgm 1 79 117 180 26 180 0.999 0 1 ./../config/tag_inbeng_1.yaml 865e6 0 $w_info_gain $w_travel_distance $w_sensing_time $w_rfid_gain /tmp/result_gs_wAVG_r2.csv /tmp/coverage_gs_wAVG_r2.csv /tmp/distance_gs_wAVG_r2.csv 1 /tmp/accuracy_gs_wAVG_r2.csv $use_mcdm &>/dev/null &
        ((counter++))
        if ((counter%batch_size==0))
        then
            wait
...
do
    ...
    do
        ...
        # echo "-->[A] IG: $w_info_gain, TD: $w_travel_distance, ST: $w_sensing_time"
        echo "Testing : [$w_info_gain , $w_travel_distance, $w_sensing_time] "
        ./../build/mcdm_online_exploration ./../Images/inbeng_small_correct.pgm 1 33 45 180 26 180 0.999 0 1 ./../config/tag_inbeng_1.yaml 865e6 0 $w_info_gain $w_travel_distance $w_sensing_time $w_rfid_gain /tmp/result_gs_wAVG_r3.csv /tmp/coverage_gs_wAVG_r3.csv /tmp/distance_gs_wAVG_r3.csv 1 /tmp/accuracy_gs_wAVG_r3.csv $use_mcdm &>/dev/null &
        ((counter++))
        if ((counter%batch_size==0))
        then
            wait

...
# 1) Load all the data for thr 5 environment
# Orebro
...
# ILIAD
iliad_mcdm_data = np.loadtxt(open("/home/pulver/Dropbox/University/PostDoc/MCDM/mcdm/logic_exps/ILIAD/coverage_mcdm_ILIAD_28.csv", "rb"), delimiter=",", skiprows=1)
...
# INB_3123
inb3123_mcdm_data = np.loadtxt(open("/home/pulver/Dropbox/University/PostDoc/MCDM/mcdm/logic_exps/inb_3123/coverage_mcdm_inb_3123_19.csv", "rb"), delimiter=",", skiprows=1)
...
# plt.figure()
fig = plt.figure(figsize=(10, 1.5))#, (ax1, ax2, ax3, ax4, ax5) = plt.subplots(1, 5, sharey=True)
...
# ax1 = plt.subplot(151)
ax1.plot(orebro_mcdm_data[:, 0], orebro_mcdm_data[:, 1], 'r', label='MCDM')
...
ax2.set_title('ILIAD', fontdict={'fontsize': 'small'})
loc = plticker.MultipleLocator(base=100.0) # this locator puts ticks at regular intervals
...
ax1.legend(loc=(1.6, 1.3), fontsize='x-small', ncol=3)
plt.show()

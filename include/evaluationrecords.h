...
public:
	...
	/**
	 * Compute the Pose object starting from a string encoding
	 * 
	 * @param encoding: the string representing a robot configuration
	 * @return the Pose object of that configuration
	 */

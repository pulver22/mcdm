...
class RadarModel
  {
    double _sizeX; // x axis size in active area
    double _sizeY; //  y axis size in active area
    int _NIC; // number of rows of global map
    int _NJC; // number of cols of global map
